...
/**
 * Given a parsed CSV row array, returns a tagscan payload object,
 * or null when the row is too short to be a valid reader frame.
 *
 ...
 */
export function buildTagscan (row) {
